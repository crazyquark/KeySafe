...
public struct BaseConverter {
    ...
    public static  func convertBase(str: String, fromBase: Int, toBase: Int, forRipple: Bool = false) -> String {
        ...
        for (var i = outArray.count - 1; i >= 0; i--) {
            out += toBaseConverter.intToString(outArray[i], forRipple: forRipple)
        }
    ...
    func intToString (digit: Int, forRipple: Bool = false) -> String {
        ...
        case 58: // This is a bitcoin specific variant!
            ...
            // Ripple alphabet
            let rAlphabet = Array("rpshnaf39wBUDNEGHJKLM4PQRST7VWXYZ2bcdeCg65jkm8oFqi1tuvAxyz".characters)
            
            return forRipple ? String(rAlphabet[digit]) : alphabet[digit]
        default:
